...
python train.py \
--config-file diffusion/configuration/edm_dit_cifar.yaml \
...
python train.py \
--config-file diffusion/configuration/rectified_flow_dit_cifar.yaml \
...
python train.py \
--config-file diffusion/configuration/edm_dit_cifar.yaml \
OUTPUT_DIR output/edm/sample_dit_cifar_conditional \
DATAMODULE.DATASET.ROOT $PATH_TO_DATASET_ROOT

python train.py \
--config-file diffusion/configuration/edm_dit_cifar.yaml \
OUTPUT_DIR output/edm/epsilon_dit_cifar_conditional \
DATAMODULE.DATASET.ROOT $PATH_TO_DATASET_ROOT \
MODULE.NOISE_SCHEDULER.PREDICTION_TYPE epsilon

python train.py \
--config-file diffusion/configuration/rectified_flow_dit_cifar.yaml \
OUTPUT_DIR output/rectified_flow/velocity_dit_cifar_conditional \
DATAMODULE.DATASET.ROOT $PATH_TO_DATASET_ROOT
